	  ...
	  <!-- Header starts -->
		<header id="header">
			<nav class="navbar bg-primary">
			  	<h1 class="col-md-10 text-center">Ads Administration - Edit Category</h1>
			  	<?php
			  	if(isset($_GET['id']) && isset($_GET['cat_n'])) {
			  	}
			  	else {
			  		header("locatoion: admin-view-categories.php");
			  	}
		      ...
		      <div class=" row add-design bordered" style="padding-bottom:10px;">
                 <div class="category ">
                 	<div>
                 	 ...
                 	 <form action="edit-all-categories.php?id=<?php echo $_GET['id']; ?>" method="POST">
                         <fieldset>
                           <div class="form-group">
	                           <label for="cats">Category:</label>
	                           <input type="text" class="form-control"  value="<?php echo $_GET['cat_n']; ?>" name="category" id="cats" placeholder="" required>
                           </div>
                           
                           <div style="margin-left:45px;">
	                          <a><input type="submit" class=" btn btn-primary " value="Edit" ></a>
						      <a><input type="button" class=" btn btn-primary " onclick="location.replace('admin-view-categories.php')" value="Cancel"></a>
						   </div>
                         </fieldset>
                     </form>
