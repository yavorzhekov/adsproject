		...
		<div class="row" id="main-content">
			<div class="col-md-2 left-part"  >
				...
				<div class="card mb-3 bordered" style="margin-bottom:30px;" >
				  ...
				  <nav id="left-nav">
					  ...
					  <li>
					    <a href="published-ads.php" style="background: #daa600;">Published</a>
					  </li>
					  <li>
            ...
            <div class="col-md-10 center-part ">
            	<?php
				    ...
				    $countedRows = countProducts("ads", $ownerId, "Published");//counts ads in table
				    $prodOnPage = 2;
				    ...
				    // getAdStatus
				    $ads=showMyAds($ownerId, $prodOnPage, $pageId, "Published");
             ...
             if($pageId-1 > 0){
			    ...
			    if($toPage>$pages){
					...
					echo '  <div class=" paging my-pagination  ">
				  	     <ul class="pagination ">
					    <li class="page-item" >
					      <a class="page-link" href="published-ads.php?id=1" >First</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="published-ads.php?id='.$prev.'">Previous</a>
					    </li>
					    ';
					    for($i = $fromPage; $i <=$toPage; $i++) {
					    	
					    		echo '<li class="page-item">
									      <a class="page-link" href="published-ads.php?id='.$i.'">'.$i.'</a>
									    </li>';
					    ...
					    echo '
					    <li class="page-item">
					      <a class="page-link" href="published-ads.php?id='.$next.'">Next</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="published-ads.php?id='.$pages.'">Last</a>
					    </li>
				  </ul>
				</div>'; 
				  ?>	
