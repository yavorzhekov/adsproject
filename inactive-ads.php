		...
		<div class="row" id="main-content">
			<div class="col-md-2 left-part"  >
				...
				<div class="card mb-3 bordered" style="margin-bottom:30px;" >
				  ...
				  <nav id="left-nav">
					  ...
					  <li>
					    <a href="for-approval.php"> Waiting Approval</a>
					  </li>
					  <li>
					    <a href="inactive-ads.php" style="background: #daa600;">Inactive</a>
					  </li>
            ...
            <div class="col-md-10 center-part ">
            	<?php
				    ...
				    $countedRows = countProducts("ads", $ownerId, "Inactive");//counts ads in table
				    $prodOnPage = 2;
				    ...
				    // getAdStatus
				    $ads=showMyAds($ownerId, $prodOnPage, $pageId, "Inactive");
		 ...
		 echo '<div class=" row add-design bordered my-ads-center-side " >
				 ...
				 <div class="status col-md-3">
				  		...
				  		<a href="approve-my-ad.php?id='.$ads[$i]['ad_id'].'">Publish Again </a>
				  		<a href="edit-my-ad.php?id='.$ads[$i]['ad_id'].'" class="edit-my-ad" style="text-align:center; "> Edit</a>
				  		<a href="delete-my-ad.php?id='.$ads[$i]['ad_id'].'" class="edit-my-ad" style="text-align:center; "> Delete</a>
				 </div>
             ...
             if($pageId-1 > 0){
			    ...
			    if($toPage>$pages){
					...
					echo '  <div class=" paging my-pagination  ">
				  	     <ul class="pagination ">
					    <li class="page-item" >
					      <a class="page-link" href="inactive-ads.php?id=1" >First</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="inactive-ads.php?id='.$prev.'">Previous</a>
					    </li>
					    ';
					    for($i = $fromPage; $i <=$toPage; $i++) {
					    	
					    		echo '<li class="page-item">
									      <a class="page-link" href="inactive-ads.php?id='.$i.'">'.$i.'</a>
									    </li>';
					    ...
					    echo '
					    <li class="page-item">
					      <a class="page-link" href="inactive-ads.php?id='.$next.'">Next</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="inactive-ads.php?id='.$pages.'">Last</a>
					    </li>
				  </ul>
				</div>'; 
				 ?>
