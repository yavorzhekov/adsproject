	  ...
	  <!-- End of Header -->
		...
		<div class="row" id="main-content">
			<div class="col-md-2 left-part"  >
				...
				<div class="card mb-3 bordered" style="margin-bottom:30px;" >
				  ...
				  <nav id="left-nav">
					  ...
					  <li>
					    <a href="admin-published-ads.php" style="background: #daa600;" >Published</a>
					  </li>
					  <li>
            ...
            echo '  <div class=" paging my-pagination  ">
				  	     <ul class="pagination ">
					    <li class="page-item" >
					      <a class="page-link" href="admin-published-ads.php?catId='.$catId.'&townId='.$townId.'&id=1" >First</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="admin-published-ads.php?catId='.$catId.'&townId='.$townId.'&id='.$prev.'">Previous</a>
					    </li>
					    ';
					    for($i = $fromPage; $i <=$toPage; $i++) {
					    	
					    		echo '<li class="page-item">
									      <a class="page-link" href="admin-published-ads.php?catId='.$catId.'&townId='.$townId.'&id='.$i.'">'.$i.'</a>
									    </li>';
					    ...
					    echo '
					    <li class="page-item">
					      <a class="page-link" href="admin-published-ads.php?catId='.$catId.'&townId='.$townId.'&id='.$next.'">Next</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" 
					      href="admin-published-ads.php?catId='.$catId.'&townId='.$townId.'&id='.$pages.'">Last</a>
					    </li>
				  </ul>
				</div>'; 
