	  ...
	  <!-- End of Header -->
		...
		<div class="row" id="main-content">
			<div class="col-md-2 left-part"  >
				...
				<div class="card mb-3 bordered" style="margin-bottom:30px;" >
				  ...
				  <nav id="left-nav">
					  ...
					  <li>
					    <a href="admin-rejected-ads.php" style="background: #daa600;">Rejected</a>
					  </li>
					</ul>
				  </nav>
				</div>
            ...
            <div class="col-md-8 center-part ">
		      ...
		      <?php  
		         if(isset($_GET['id'])) {
				    ...
				    if ($catId==0 && $townId==0){
            	    	$adStatus=adInfo($adsOnPage, $pageId, "Rejected");
            	    	 $ads=getAdStatus("Rejected");
				         $pages=count($ads);
            	    	...
            	    	$adStatus=adInfo4($adsOnPage, $pageId, $townId, $catId, "Rejected");
            	    	$ads=countAds("Rejected", $townId, $catId);
            	    	$pages=count($ads);
            	    	}
		      if(empty($adStatus) != 1){
		      	...
		      	<div class="ad-wrap" >
					  ...
					  <div class="s-row">
					   ...
					   <div class="four-btns">
						  ...
						  <a href="approve-ad.php?id='.$key['ad_id'].'"><button type="submit" class=" btn btn-primary " >Approve</button></a>
            ...
            echo '   <div class=" paging my-pagination  ">
				  	     <ul class="pagination ">
					    <li class="page-item" >
					      <a class="page-link" href="admin-rejected-ads.php?catId='.$catId.'&townId='.$townId.'&id=1" >First</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="admin-rejected-ads.php?catId='.$catId.'&townId='.$townId.'&id='.$prev.'">Previous</a>
					    </li>
					    ';
					    for($i = $fromPage; $i <=$toPage; $i++) {
					    	
					    		echo '<li class="page-item">
									      <a class="page-link" href="admin-rejected-ads.php?catId='.$catId.'&townId='.$townId.'&id='.$i.'">'.$i.'</a>
									    </li>';
					    ...
					    echo '
					    <li class="page-item">
					      <a class="page-link" href="admin-rejected-ads.php?catId='.$catId.'&townId='.$townId.'&id='.$next.'">Next</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" 
					      href="admin-rejected-ads.php?catId='.$catId.'&townId='.$townId.'&id='.$pages.'">Last</a>
					    </li>
				  </ul>
				</div>'; 
				 ?>
