		...
		<div class="row" id="main-content">
			<div class="col-md-2 left-part"  >
				...
				<div class="card mb-3 bordered" style="margin-bottom:30px;" >
				  ...
				  <nav id="left-nav">
					  ...
					  <li>
					    <a href="for-approval.php">Inactive</a>
					  </li>
					  <li>
					    <a href="inactive-ads.php" > Waiting Approval</a>
					  </li>
					  <li>
					    <a href="rejected-ads.php"  style="background: #daa600;">Rejected</a>
					  </li>
					</ul>
				  </nav>
				</div>
            ...
            <div class="col-md-10 center-part ">
            	<?php
				    ...
				    $countedRows = countProducts("ads", $ownerId, "Rejected");//counts ads in table
				    $prodOnPage = 2;
				    ...
				    // getAdStatus
				    $ads=showMyAds($ownerId, $prodOnPage, $pageId, "Rejected");
		 ...
		 echo '<div class=" row add-design bordered my-ads-center-side " >
				 ...
				 <div class="status col-md-3">
				  		...
				  		<a href="deactivate-ad.php?id='.$ads[$i]['ad_id'].'">Deactivate </a>
             ...
             if($pageId-1 > 0){
			    ...
			    if($toPage>$pages){
					...
					echo '  <div class=" paging my-pagination  ">
				  	     <ul class="pagination ">
					    <li class="page-item" >
					      <a class="page-link" href="rejeted-ads.php?id=1" >First</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="rejeted-ads.php?id='.$prev.'">Previous</a>
					    </li>
					    ';
					    for($i = $fromPage; $i <=$toPage; $i++) {
					    	
					    		echo '<li class="page-item">
									      <a class="page-link" href="rejected-ads.php?id='.$i.'">'.$i.'</a>
									    </li>';
					    ...
					    echo '
					    <li class="page-item">
					      <a class="page-link" href="rejeted-ads.php?id='.$next.'">Next</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="rejeted-ads.php?id='.$pages.'">Last</a>
					    </li>
				  </ul>
				</div>'; 
				  ?>
