	  ...
	  <!-- Header starts -->
		<header id="header">
			<nav class="navbar bg-primary">
			  	<h1 class="col-md-10 text-center">Ads Administration - Edit Town</h1>
			  	<?php
			  	if(isset($_GET['town_n']) && isset($_GET['id'])) {}
			  		else {
			  			header('location: admin-view-towns.php');
			  		}
		...
		<div class="row" id="main-content">
			<div class="col-md-2 left-part"  >
				<div class="card mb-3 bordered" style="margin-bottom:10px; " >
				  ...
				  <nav id="left-nav">
					  ...
					  <li>
					    <a href="admin-view-categories.php" s>Categories</a>
					  </li>
					  <li>
            ...
            <div class="col-md-4 center-part">
		      <div class=" row add-design bordered" style="padding-bottom:10px;">
                 <div class="category ">
                 	<div>
                 	   	 <h1 class="text-center">Edit Town</h1>
                 	   	 <div class="line" style="width:85%;"></div>
                     </div>
                 	 <form action="edit-town.php?id=<?php echo $_GET['id']; ?>" method="POST">
                         <fieldset>
                           <div class="form-group">
	                           <label for="towns">Town:</label>
	                           <input type="text" class="form-control" 
	                           value="<?php echo $_GET['town_n']; ?>" 
	                           name="town" id="towns" placeholder="" required>
                           </div>
