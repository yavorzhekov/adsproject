	  ...
	  <!-- Header starts -->
		<header id="header">
			<nav class="navbar bg-primary">
			  	<h1 class="col-md-10 text-center">Ads Administration - Create Town</h1>
			  	<?php
		...
		<div class="row" id="main-content">
            ...
            <div class="col-md-4 center-part">
		      <div class=" row add-design bordered" style="padding-bottom:10px;">
                 <div class="category ">
                 	<div>
                 	   	 <h1 class="text-center">Create Town</h1>
                 	   	 <div class="line" style="width:85%;"></div>
                     </div>
                 	 <form action="create-town.php" method="POST">
                         <fieldset>
                           <div class="form-group">
	                           <label for="cats">Town:</label>
	                           <input type="text" class="form-control" name="town" id="cats" placeholder="" required>
                           </div>
