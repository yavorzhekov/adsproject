		...
		<div class="row" id="main-content">
			<div class="col-md-2 left-part"  >
				...
				<div class="card mb-3 bordered" style="margin-bottom:30px;" >
				  ...
				  <nav id="left-nav">
				  	<ul>
					  <li>
					    <a href="my-ads.php" style="background: #daa600;">All</a>
					  </li>
					  <li>
            ...
            <div class="col-md-10 center-part ">
            	<?php
				    ...
				    $countedRows = countProducts("ads", $ownerId);//counts ads in table
				    $prodOnPage = 2;

				    $pages = ceil($countedRows["countedProd"]/$prodOnPage);
				  
            	    $ads=showMyAds($ownerId, $prodOnPage, $pageId, null);
				    //echo count($myAds);
		...
		echo '<div class=" row add-design bordered my-ads-center-side " >
			    ...
			    if($toPage>$pages){
					...
					echo '  <div class=" paging my-pagination  ">
				  	     <ul class="pagination ">
					    <li class="page-item" >
					      <a class="page-link" href="my-ads.php?id=1" >First</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="my-ads.php?id='.$prev.'">Previous</a>
					    </li>
					    ';
					    for($i = $fromPage; $i <=$toPage; $i++) {
					    	
					    		echo '<li class="page-item">
									      <a class="page-link" href="my-ads.php?id='.$i.'">'.$i.'</a>
									    </li>';
					    ...
					    echo '
					    <li class="page-item">
					      <a class="page-link" href="my-ads.php?id='.$next.'">Next</a>
					    </li>
					    <li class="page-item">
					      <a class="page-link" href="my-ads.php?id='.$pages.'">Last</a>
					    </li>
				  </ul>
				</div>'; 
				  ?>	
