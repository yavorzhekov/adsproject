	  ...
	  <!-- Header starts -->
		<header id="header">
			<nav class="navbar bg-primary">
			  	<h1 class="col-md-10 text-center">Ads Administration - Create Category</h1>
			  	<?php
                 	 ...
                 	 <form action="create-category.php" method="POST">
                         <fieldset>
                           <div class="form-group">
	                           ...
	                           <input type="text" class="form-control" name="category" id="cats" placeholder="" required>
                           </div>
                           
                           <div style="margin-left:45px;">
	                           <a><input type="submit" class=" btn btn-primary " value="Create" ></a>
