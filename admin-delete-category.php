	  ...
	  <!-- Header starts -->
		<header id="header">
			<nav class="navbar bg-primary">
			  	<h1 class="col-md-10 text-center">Ads Administration - Delete Category</h1>
			  	<?php
		...
		<div class="row" id="main-content">
            ...
            <div class="col-md-4 center-part">
		      <div class=" row add-design bordered" style="padding-bottom:10px;">
                 <div class="category ">
                 	<div>
                 	   	 <h1 class="text-center">Confirm Deleting Category ?</h1>
                 	   	 <div class="line" style="width:85%;"></div>
                     </div>
                 	 <form action="delete-category.php?id=<?php echo $_GET['id']; ?>" method="POST">
                         <fieldset>
                           <div class="form-group">
	                           <label for="cats">Category:</label>
	                           <span  id="cats"> <?php echo $_GET['cat_n']; ?> </span>
                           </div>
